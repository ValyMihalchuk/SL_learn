...
Makefile.conf: _CoqProject
	coq_makefile -f _CoqProject Affine.v Arrays.v Basic.v Bib.v Himpl.v Hprop.v LibAxioms.v LibBool.v LibChoice.v LibContainer.v LibCore.v LibEpsilon.v LibEqual.v LibFun.v LibInt.v LibList.v LibListExec.v LibListZ.v LibLogic.v LibMin.v LibMonoid.v LibMultiset.v LibNat.v LibOperation.v LibOption.v LibOrder.v LibProd.v LibReflect.v LibRelation.v LibSepFmap.v LibSepMinimal.v LibSepReference.v LibSepSimpl.v LibSepTLCbuffer.v LibSepVar.v LibSet.v LibString.v LibSum.v LibTactics.v LibUnit.v LibWf.v Postscript.v Preface.v Records.v Repr.v Rules.v Triples.v WPgen.v WPsem.v WPsound.v Wand.v -o Makefile
